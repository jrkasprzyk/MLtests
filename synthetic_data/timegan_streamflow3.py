...
# monthly data, want it in 5 year chunks
seq_len = 12*5
model_output_filename = 'synthesizer_oakcreek_5year.pkl'
...
if path.exists(model_output_filename):
    synth = TimeSeriesSynthesizer.load(model_output_filename)
else:
    synth = TimeSeriesSynthesizer(modelname='timegan', model_parameters=gan_args)
    synth.fit(obs_monthly_af, train_args, num_cols=cols)
    synth.save(model_output_filename)
...
output_flows.to_excel("./data/100years_5yearchunks.xlsx")
